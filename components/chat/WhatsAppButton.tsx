...
export function WhatsAppButton({ phoneNumber, gigTitle, className }: WhatsAppButtonProps) {
  if (!phoneNumber) return null

  const cleanNumber = phoneNumber.replace(/\D/g, '')
  const message = gigTitle
    ? `Hi! I'm reaching out about your Unigigs listing: "${gigTitle}"`
    : 'Hi! I found you on Unigigs.'
